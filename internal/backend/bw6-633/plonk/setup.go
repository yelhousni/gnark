...
type PublicRaw struct {
	...
	Ql, Qr, Qm, Qo, Qk bw6633.Polynomial
	...
	LS1, LS2, LS3 bw6633.Polynomial
	CS1, CS2, CS3 bw6633.Polynomial
...
func SetupRaw(spr *cs.SparseR1CS, polynomialCommitment polynomial.CommitmentScheme, publicWitness bw6_633witness.Witness) *PublicRaw {
...
func ComputeS(publicData *PublicRaw) {
	...
	publicData.LS1 = make(bw6633.Polynomial, nbElmt)
	publicData.LS2 = make(bw6633.Polynomial, nbElmt)
	publicData.LS3 = make(bw6633.Polynomial, nbElmt)
	for i := 0; i < nbElmt; i++ {
	...
	publicData.CS1 = make(bw6633.Polynomial, nbElmt)
	publicData.CS2 = make(bw6633.Polynomial, nbElmt)
	publicData.CS3 = make(bw6633.Polynomial, nbElmt)
