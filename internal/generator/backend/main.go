...
func main() {
	...
	bw6_672 := templateData{
		RootPath: "../../../internal/backend/bw6-672/",
		Curve:    "BW6-672",
		CurveID:  "BW6_672",
		Package:  "bw6672",
	}

	datas := []templateData{bls12_377, bls12_381, bn254, bw6_761, bls24_315, bw6_633, bw6_672}
...
type templateData struct {
	RootPath string
	Curve    string // BLS381, BLS377, BN254, BW761, BLS315, BW633
	Package  string
	CurveID  string
}
